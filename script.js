...
// ===== GCODE GENERATION - NOZZLE EJECT =====
function generateEjectGcode() {
    const ejectGcode = `;==========================
; Bambu A1 - Nozzle Eject Routine
;==========================
M400
...
; --- Retract nozzle safely ---
G1 Z250 F3000          ; Raise nozzle high
G1 X60 Y60 F6000       ; Move to center of bed
M400

; --- Lower nozzle near print to scrape ---
G1 Z5 F1500            ; Lower nozzle (5mm from bed)
G4 P500                ; Wait 0.5s

; --- Scrape/eject print with nozzle at high speed ---
; Move X axis quickly front → back (scrape print)
G1 X20 F15000          ; Move nozzle forward quickly
G4 P200

G1 X100 F15000         ; Move nozzle backward
G4 P200

G1 X20 F15000          ; Second scrape - move forward
G4 P200

G1 X100 F15000         ; Move nozzle backward
G4 P200

G1 X20 F15000          ; Third scrape - move forward
G4 P200

; --- Lower deeply to pop print off bed ---
G1 Z-10 F2000          ; Lower nozzle deep (below bed level)
G4 P1000

; --- Final cleanup ---
G1 X60 F8000           ; Return to center

; --- End ---
G1 Z250 F3000
G1 X0 Y0 F6000
M400
M300 S1000 P200        ; Beep signal complete

;==========================
; END NOZZLE EJECT ROUTINE
;==========================
`;
    return ejectGcode;
}
